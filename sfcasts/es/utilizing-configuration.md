...
Ve al navegador y haz clic en un artículo. Aparecerá un error: "Demasiados pocos argumentos para ... ObjectTranslator::__construct(), 2 pasados... 3 esperados".
...
En `ObjectTranslationBundle::loadExtension()`, fíjate en el argumento `array $config`. Dentro de este método, vuélcalo con: `dd($config)`. De vuelta en el navegador, actualiza.
...
Una de las ventajas de trabajar en tu bundle dentro de una aplicación es que puedes obtener el autocompletado del plugin PhpStorm + Symfony para tus servicios.
...
Vuelve a tu navegador y actualiza. ¡Muy bien! No hay errores.
